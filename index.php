        ...
        <div class="navbar-fixed">
            <nav class="navbar-color";>
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <!-- <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-3"><img src="images/bjlogos.png" alt="logo" width="200" height="40"></a> <span class="logo-text">Logo</span></h1></li> -->
                    </ul>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            <li class="user-details cyan darken-3">
            <div class="row">
      ...
      <section id="content">
        ...
        // $result = $action->check();
        // echo "</p>";
				//$result = mysqli_query($db, "SELECT * FROM items where not deleted;");
        $result = $action->notDeletedItems();
