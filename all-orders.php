...
<div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <!-- <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/" alt="logo" width="100%" height="50%"></a> <span class="logo-text">Logo</span></h1></li> -->
                    </ul>
...
<div id="work-collections" class="seaction">
					...
					$sql = mysqli_query($db, "SELECT * FROM orders WHERE status LIKE '$status';");
					echo '<div class="row">
                <div>
					...
					while($row = mysqli_fetch_array($sql))
					{
						...
						$sql3 = $action->matchCostumer($customer_id);
