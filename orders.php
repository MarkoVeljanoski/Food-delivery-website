...
include "./routers/actionsClass.php";
$action = new Actions();
  ...
  <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <!-- <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/bjlogos.png" alt="logo" width="200" height="40"></a> <span class="logo-text">Logo</span></h1></li> -->
                    </ul>
        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <div class="row">
                <div class="col col s4 m4 l4">
                    <img src="images/avatar1.png" alt="" class="circle responsive-img valign profile-image">
                </div>
                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> Orders</a>
                            <div class="collapsible-body">
								...
								<?php
									$sql = $action->costumerStatus($user_id);
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Your Past Orders</h5>
              </div>
            </div>
          </div>
        </div>
...
<div id="work-collections" class="seaction">
					...
					$sql = $action->statusOfCostumer($user_id,$status);
					echo '              <div class="row">
                <div>
					...
					while($row = mysqli_fetch_array($sql))
					{
						...
						$order_id = $row['id'];
						$sql1 = $action->matchOrders($order_id);
						while($row1 = mysqli_fetch_array($sql1))
						{
							$item_id = $row1['item_id'];
							$sql2 = $action->matchItem($item_id);
							...
							$id = $row1['order_id'];
								...
								echo'<li class="collection-item">
                                        <div class="row">
                                            ...
                                            <div class="col s3">
                                                <span><strong>MKD '.$row['total'].'</strong></span>
                                            </div>';
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2022 <a class="grey-text text-lighten-4" href="#" target="_blank">SEEU</a> All rights reserved.</span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
