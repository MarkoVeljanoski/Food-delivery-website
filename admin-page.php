...
<div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <!-- <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/bjlogos.png" alt="logo" width="50" height="50"></a> <span class="logo-text">Logo</span></h1></li> -->
                    </ul>
...
<table>
  ...
  <footer class="page-footer">
    ...
    $("#formValidate").validate({
        rules: {
			<?php
			//$result = mysqli_query($con, "SELECT * FROM items"); CHECK IF WORKS WITHOUT THIS
			while($row = mysqli_fetch_array($result))
			{
				echo $row["id"].'_name:{
				required: true,
        ...
        messages: {
			<?php
			$result = mysqli_query($con, "SELECT * FROM items"); //LOOK
			while($row = mysqli_fetch_array($result))
			{  
				echo $row["id"].'_name:{
